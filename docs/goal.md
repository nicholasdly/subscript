...
`subscript` will eventually be a published on the npm registry, where any and all developers can use it for natural language parsing. `subscript` should be performant and have as few dependencies as possible (if not zero).
